...
HD_PWD='C:/Users/Laptop/Documents/projects/io_lab2/io_lab2/io_lab2.runs/uc_system_Timer_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uc_system_Timer_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uc_system_Timer_0_1.tcl
